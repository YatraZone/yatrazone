...
const FilterBanner = () => {
    ...
    useEffect(() => {
        const fetchBanners = async () => {
            try {
                const response = await fetch("/api/filterBanner");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Refresh banner list
                const updatedBanners = await fetch("/api/filterBanner").then((res) => res.json());
            ...
            <Table>
                ...
                <TableBody>
                    {banners.length > 0 ? (
                        ...
                        <TableRow>
                            <TableCell colSpan="5" className="text-center py-4">No banner found</TableCell>
                        </TableRow>
                    )}
                </TableBody>
            </Table>
