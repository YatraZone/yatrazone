...
const ManageArtisanBlogs = ({ artisanId, artisanDetails = null }) => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "min-h-[300px] border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-[#00b67a]",
        spellcheck: "true",
      },
    },
    autofocus: true,
  ...
  const setLink = React.useCallback(() => {
    ...
    const url = window.prompt(
      "Enter URL (without /product/ prefix):",
      previousUrl
    );
    if (url === null) return;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(
          editMode ? "Blog updated successfully!" : "Blog created successfully!"
        );
        fetchBlogs(selectedArtisan || artisanId);
        handleCancelEdit();
      } else {
      ...
      <div className="container-fluid">
        <div className="row justify-center">
          <div className="w-full max-w-5xl mx-auto">
            <h3 className="my-4 text-center font-bold text-2xl">
              Create Promotions Video / Image
            </h3>
                    ...
                    <div>
                      ...
                      <div className="border rounded p-4 mt-2">
                        ...
                        <Button
                          ...
                          disabled={
                            imageUploading || selectedImages.length >= 10
                          }
                        >
                    ...
                    <div className="bg-white rounded shadow-lg max-w-lg w-full p-8 relative">
                      ...
                      <div className="grid grid-cols-1 gap-4 mb-2">
                        ...
                        <div className="bg-white p-3 rounded border border-gray-200 shadow-md mb-2 ">
                          ...
                          <div className="text-gray-600 break-all">
                            {selectedArtisanBlogs[0].youtubeUrl ? (
                              <a
                                href={
                                  selectedArtisanBlogs[0].youtubeUrl.startsWith(
                                    "http"
                                  )
                                    ? selectedArtisanBlogs[0].youtubeUrl
                                    : `https://${selectedArtisanBlogs[0].youtubeUrl}`
                                }
                                target="_blank"
                        ...
                        <div className="bg-white p-3 rounded border border-gray-200 shadow-md mb-2">
                          ...
                          <div className="text-gray-600">
                            {selectedArtisanBlogs[0].shortDescription || "-"}
                          </div>
                        </div>
                        ...
                        <div className="bg-white p-3 rounded border border-gray-200 shadow-md mb-2 max-h-24 overflow-y-auto">
                          ...
                          <div
                            dangerouslySetInnerHTML={{
                              __html: selectedArtisanBlogs[0].longDescription,
                            }}
                            className="ProseMirror1 text-gray-600 whitespace-pre-line"
                          ></div>
                        </div>
                        <div className="bg-white p-3 rounded border border-gray-200 shadow-md mb-2 max-h-32 overflow-y-auto">
                          ...
                          <div className="flex flex-wrap gap-2 mt-2">
                            {Array.isArray(selectedArtisanBlogs[0].images) &&
                            selectedArtisanBlogs[0].images.length > 0 ? (
                      ...
                      <button
                        className="absolute w-8 h-8 top-2 right-2 text-gray-700 hover:text-red-600"
                        onClick={() => setShowBlogsModal(false)}
                      >
                        X
                      </button>
                      <button
                        className="absolute px-4 py-1 bottom-2 right-2 border border-gray-200 rounded bg-red-500 text-white"
                        onClick={() => setShowBlogsModal(false)}
                      >
                        Close
                      </button>
