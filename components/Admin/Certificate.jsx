      ...
      <div className="container-fluid">
        <div className="row justify-center">
          <div className="w-full max-w-5xl mx-auto">
            <h3 className="my-4 text-center font-bold text-2xl">Create Destination Certificate</h3>
                      ...
                      groupedByArtisan.map((group, idx) => (
                        group.certificates && group.certificates.length > 0 ? (
                          ...
                          <TableRow key={group.artisan._id + '-empty'}>
                            ...
                            <TableCell className="px-4 py-3" colSpan={4}>No certificates for this Destination.</TableCell>
                          </TableRow>
                        )
                      ))
                    ) : (
